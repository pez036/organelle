...
import Axios from "axios";
import "./Profile.css"
import ChangePasswordModal from "../misc/ChangePasswordModal";
class Profile extends Component{
    ...
    modalHandler = () => {
        this.state.passwordModal ? this.setState({passwordModal : false}) : this.setState({passwordModal : true});
    }
    scheduleSend(){
    ...
    render(){
        ...
        return (
            <div>
                <div>
                    <NaviBar />
                    <ChangePasswordModal action={this.modalHandler} show={this.state.passwordModal}/>
                    <div className = "top-right">
                        <div className = "profile-form">
                            ...
                            <div className="profile-body">
                                ...
                                <Button onClick={this.modalHandler}>Change Password</Button>
