    ...
    <div className="homePage">
        ...
        <section className="features">
                ...
                <div className="f1grid">
                    <img height="250" width="670" src={calImg} alt="feature 1"/>
                    <h4 class="vertical">Get an overview of upcoming lectures and deadlines for the month using the Calendar view. You can add events individually, upload your own .ics calendar file, or import from Canvas. Organelle allows you to easily navigate your personal study plan by keeping you up to date on your tasks for the month.
                ...
                <div className="f2grid">
                    <img height="200" width="670" src={canvasImg} alt="feature 2"/>
                    <h4 class="vertical">Already have important events on your Canvas calendar? Organelle saves you the hassle of manually uploading each event with its Import from Canvas capability. This allows you to include every event on your personal Canvas calendar on your Organelle account.
